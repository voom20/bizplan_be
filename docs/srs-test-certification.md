...
│                                                                              │
├──────────────────────────────────────────────────────────────────────────────┤
│  TOTAL: 176 tests | 0 failures | 0 ignored | 6.0s                            │
└──────────────────────────────────────────────────────────────────────────────┘
```
...
│  │    🟢 com.vibe.bizplan.bizplan_be.api         46     0     0   0.700s  │  │
│  │    🟢 com.vibe.bizplan.bizplan_be.domain     110     0     0   0.650s  │  │
│  │    🟢 com.vibe.bizplan.bizplan_be.infra       19     0     0   0.233s  │  │
│  │    ─────────────────────────────────────────────────────────────────   │  │
│  │    TOTAL                                     176     0     0   6.000s  │  │
│  │                                                                        │  │
│  └────────────────────────────────────────────────────────────────────────┘  │
│                                                                              │
│                      ╔═══════════════════════════╗                           │
